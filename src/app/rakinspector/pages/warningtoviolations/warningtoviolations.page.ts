...
@Component({
  selector: 'app-warningtoviolations',
  templateUrl: './warningtoviolations.page.html',
  styleUrls: ['./warningtoviolations.page.scss'],
})
export class WarningtoviolationsPage implements OnInit {
    ...
    this.connectivity.appIsOnline$.subscribe(async online => {
      if (online) {
        let payload = {
          ...
          warning_type:'warning_to_violations' 
        }
